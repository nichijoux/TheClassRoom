...
export default {
  ...
  methods: {
    ...
    // 新增
    saveData() {
      couponInfoAPI.addCouponInfo(this.couponInfo).then((response) => {
        // debugger
        if (response.code) {
          this.$message({
            type: "success",
    ...
    // 根据id更新记录
    updateData() {
      couponInfoAPI.updateCouponInfo(this.couponInfo).then((response) => {
        debugger;
        if (response.code) {
          this.$message({
            type: "success",
    ...
    // 根据id查询记录
    fetchDataById(id) {
      couponInfoAPI.getCouponInfo(id).then((response) => {
